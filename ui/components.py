...
class ControlPanel:
    ...
    def _create_widgets(self):
        ...
        ttk.Label(self.frame, text="Presets:", font=UI_CONFIG['fonts']['label']).grid(
            row=0, column=2, padx=(15, 5), pady=padding)

...
- Download the [latest release](https://github.com/Profetorum/y-cruncher_GUI/releases) .zip file ( [y-cruncher0.8.6](https://www.numberworld.org/y-cruncher/) required )
